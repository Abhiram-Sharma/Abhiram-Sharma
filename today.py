...
HEADERS = {'authorization': 'token '+ "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"}
USER_NAME = "Abhiram-Sharma" # 'Andrew6rant'
...
if __name__ == '__main__':
    ...
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2005, 7, 5))
